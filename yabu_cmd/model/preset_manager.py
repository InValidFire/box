...
class PresetManager:
    ...
    def __new__(
        cls, file_path: Path, *args, **kwargs
    ):  # file_path arg is given to remove from *args and avoid passing it to super()
    ...
    def config_file(self, new_path: Path) -> None:
        """Setter for the file_path argument. Ensures the path exists, is a
        file, and has a .json extension.
        ...
        Raises:
            ...
            ValueError: If the new_path is not a file or does not have a
                .json extension.
        """
